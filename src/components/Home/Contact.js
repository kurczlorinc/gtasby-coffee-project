...
export default function Contact() {
    return (
        ...
        <div className="row">
            ...
            <form action="https://formspree.io/kurcz.l3@gmail.com" method="POST">
                {/* name */}
                ...
                <div className="form-group">
                    ...
                    <textarea className="form-control" rows="5" name="description" id="description" placeholder="your description goes here" />        
                </div>
                {/* submit */}
